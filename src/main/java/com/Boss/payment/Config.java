...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:4200/shop/donhang/thanh-toan";
    public static String vnp_TmnCode = "89V4CO24";
    public static String vnp_HashSecret = "NFPUKPXKUOFCJJPQOXAMEKHJRJGCYJHB";
